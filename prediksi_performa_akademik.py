...
def main():
    ...
    st.header('Prediksi Potensi Akademik Mahasiswa')
    ...
    if choice == "Beranda":
        ...
        st.write('Banyak variabel yang mempengaruhi potensi akademik mahasiswa baik variabel perilaku didalam pembelajaran maupun variabel lainnya. Pada sistem informasi prediksi potensi akademik mahasiswa ini variabel yang digunakan adalah variabel akademik dan non-akademik.') 
        ...
        st.write('Prediksi potensi akademik ini menggunakan dua sumber data yaitu 1). Data Akademik Mahasiswa IPK Semester dan Data Nilai Ijazah Calon Mahasiswa  2). Data non-akademik (gender, umur, gaji orang tua, jumlah saudara).')
        ...
        isi = ( "Prediksi Potensi Akademik Mahasiswa Menggunakan Data Non-Akademik dan Akademik" + "\n" + "\n" +
                "###Data Non Akademik" + "\n" +
                "Gender = " + jekel + "\n" +
                "Umur = " + umur + "\n" +
        ...
        with col1:
                ...
                kelengkapan = st.radio(
                    'Kelengkapan dalam memprediksi potensi akademik',
                    ('Sangat Baik', 'Baik', 'Cukup Baik','Kurang Baik'))
        ...
        st.write('Sistem Informasi Prediksi Potensi Akademik Mahasiswa ini dibuat dengan menggunakan bahasa pemprograman :blue[Python] dan :blue[Streamlit], sistem ini menggunakan model yang terbentuk dari algoritma :blue[LSTM dan SVM]. Sedangkan data yang digunakan untuk membangun model berasal dari data akademik dan data non-akademikdemik yang diperoleh dari :blue[Universitas Semarang].')
        st.write('Dalam melakukan prediksi Model ini memiliki tingkat kesalahan sebesar 10%')

        #st.image(image, caption='Bobot Fitur')

        st.write('Untuk informasi lebih lanjut terkait Prediksi Potensi Akademik Mahasiswa ini, dapat menghubungi Sri Handayani: 081232566827 ')
